const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-04-04', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '藤', url: '/tag/藤' },
  HEO_HERO_CATEGORY_2: { title: '井', url: '/tag/井' },
  HEO_HERO_CATEGORY_3: { title: '树', url: '/tag/树' },
